...
public final class Permission
    ...
    public static Permission compile(String string) {
        Preconditions.argument(StringUtil.notEmpty(string), "permission node string is empty!");
    ...
    public Accessible acceptable(Permission permission) {
        Preconditions.nonNull(permission, "required permission");
    ...
    public Accessible acceptable(String permision) {
        Preconditions.argument(StringUtil.notEmpty(permision), "permission");
